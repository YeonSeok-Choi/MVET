...
#' @param way The type of MANOVA to perform ("one" for one-way or "two" for two-way). (default = "\code{one}")
#' @param method The method for MANOVA analysis. "Wilks" represents Wilks' lambda, "LH" represents Lawley-Hotelling trace, "Pillai" represents Pillai-Bartlett trace, "Roy" represents Roy's largest root, and "all" represents all methods. (default is "\code{all}")
